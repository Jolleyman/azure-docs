...
4. Paste the certificate data into the **Public Certificate Data** section of the portal. Put the name of the certificate in the **Name** space, and then click **Save**. You can add up to 20 trusted root certificates.
    ...
    If you get an error upon upload indicating that the root cert is invalid, take the text into a text editor where you can clearly remove all the carriage returns and line feeds. Then, paste this into the Public Certification Data field.
